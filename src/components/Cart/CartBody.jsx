    ...
    <div className="container">
      ...
      <div className="cart-buttons-wrapper">
        <div className="cart-buttons-left">
          ...
          <a href="#" className="btn btn-custom btn-custom-primary">Apply Coupon</a>
        </div>
        <a href="#" className="btn btn-custom btn-custom-primary">Update Cart</a>
      </div>
    </div>
  </div>
  {/* <!-- Cart Table End -->
    ...
    <div className="cart-total-section">
      <div className="container">
        <div className="section-top-box stp-left">
          <h2 className="st-title">Cart Total</h2>
        </div>
